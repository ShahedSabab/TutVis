...
def fileWrite(fileNumber):
    ...
    command_path = r'''D:\CLoud\Academic\Research\___\Analysis (Photoshop)\4.2 Analysis Visualization - pyLDAvis (Using 750 symmetrical data)\5. Feature(Command Ratio)\Command List\commandList_processed_V1.txt'''
...
path = r'''D:\CLoud\Academic\Research\___\Analysis (Photoshop)\4.2 Analysis Visualization - pyLDAvis (Using 750 symmetrical data)\5. Feature(Command Ratio)\Result\out_V1.csv'''
